...
type ConcernBoardScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ConcernBoardScreen'>;
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.title}>고민게시판</Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity
                        onPress={() => navigation.navigate('ConcernPostDetailScreen', { post: item })}
                    >
                ...
                <TouchableOpacity style={styles.modalOverlay} onPress={() => setModalVisible(false)}>
                    <View style={styles.modalContainer}>
                        <TouchableOpacity style={styles.modalButton} onPress={() => {
                            ...
                            navigation.navigate('PostRegisterScreen'); // 게시글 등록 페이지로 이동
                        }}>
...
const styles = StyleSheet.create({
    ...
    icon: { marginLeft: '2%' },
    buttonContainer: { flexDirection: 'row', justifyContent: 'flex-start', marginBottom: '2%', paddingVertical: '2%', paddingHorizontal: '2%' },
    categoryButton: { paddingVertical: '2%', paddingHorizontal: '3%', borderRadius: '15%', backgroundColor: '#F8F8F8', marginRight: '2.5%' },
    selectedCategory: { backgroundColor: '#FFEB3B' },
    categoryButtonText: { fontSize: '16%', color: '#000' },
    itemContainer: { flexDirection: 'row', padding: '4%', borderBottomWidth: 1, borderBottomColor: '#EEE', backgroundColor: '#FFFFFF' },
    itemContent: { flex: 1 },
    itemTitle: { fontSize: '18%', fontWeight: 'bold' },
    itemDetails: { fontSize: '11%', color: '#888' },
    itemText: { marginVertical: '3%', fontSize: '14%', color: '#555' },
    itemFooter: { flexDirection: 'row', alignItems: 'center' },
    itemFooterText: { marginHorizontal: '1%', fontSize: '13%', color: '#888' },
    itemImagePlaceholder: { width: '15%', height: undefined, aspectRatio: 1, marginLeft: '4%', borderRadius: '10%', backgroundColor: '#D3D3D3' },
    floatingButton: {
        position: 'absolute',
        bottom: '5%',
        right: '5%',
