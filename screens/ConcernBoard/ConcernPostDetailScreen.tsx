...
export default function ConcernPostDetailScreen({ route, navigation }) {
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const response = await fetch(`https://your-api.com/concerns/${post.id}/comments`);
            ...
            [
                { text: "취소", style: "cancel" },
                {
                    text: "신고", onPress: async () => {
                        try {
                            const response = await fetch(`https://your-api.com/concerns/${post.id}/report`, {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>고민게시판</Text>
            ...
            <View style={styles.postContainer}>
                ...
                <Text style={styles.postDetails}>{post.author} | {post.date}</Text>
